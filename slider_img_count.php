...
<!-- 
    ...
    <link href="https://trianstudios.com/assets/css/pace-theme-flash.css?6138e73f2247b1.87705451" rel="stylesheet" type="text/css" />
...
<body class="scrollbar-hidden">
                ...
                <div class="swiper-wrapper">                                            
                        ...
                        <div class="swiper-slide fit">
                            ...
                            <div class="slider-wrapper">
                                <div class="background-wrapper" data-swiper-parallax="30%">
                                    ...
                                    <div class="background" data-pages-bg-image="./images/count_down_slider/1st_Slide.jpg" style="background-color: #af84f1;"></div>
                                </div>
                            </div>
                            <!-- END IMAGE PARRALAX -->
                            <!-- BEGIN CONTENT -->
                        ...
                        <div class="swiper-slide fit">
                            ...
                            <div class="slider-wrapper">
                                <div class="background-wrapper" data-swiper-parallax="30%">
                                    <!-- YOUR BACKGROUND IMAGE HERE, YOU CAN ALSO USE IMG with the same classes -->
                                    <div class="background" data-pages-bg-image="./images/count_down_slider/2nd_Slide.jpg" style="background-color: #af84f1;"></div>
                                </div>
                            </div>
                            <!-- END IMAGE PARRALAX -->
                            <!-- BEGIN CONTENT -->
    ...
    <!-- END JUMBOTRON -->
        ...
        <script type="text/javascript" src="https://trianstudios.com/assets/js/pace.min.js"></script>
    ...
    <script type="text/javascript" src="https://trianstudios.com/assets/js/sliders.js"></script>
    <script type="text/javascript" src="https://trianstudios.com/assets/js/style.js"></script>
    <script type="text/javascript" src="https://trianstudios.com/assets/js/contact.js"></script>
