...
<head>
    ...
    <link href="https://trianstudios.com/assets/css/bootstrap.min.css?6138e73f224811.48526643" rel="stylesheet" type="text/css" />
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide fit">
                            ...
                            <div class="slider-wrapper">
                                <div class="background-wrapper" data-swiper-parallax="30%">
                                    <!-- YOUR BACKGROUND IMAGE HERE, YOU CAN ALSO USE IMG with the same classes -->
                                    <div class="background" data-pages-bg-image="./images/second_img.jpg" style="background-color: #e2b48b"></div>
                                </div>
                            </div>
                            <!-- END IMAGE PARRALAX -->
                            <!-- BEGIN CONTENT -->
