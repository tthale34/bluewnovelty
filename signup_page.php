...
<html lang="en">
	<head>
		...
		<script src="<?php echo $url;?>js/jquery.equalheights.js"></script>
		<script src="<?php echo $url;?>js/jquery.mobilemenu.js"></script>
		<script src="<?php echo $url;?>js/jquery.easing.1.3.js"></script>
		<script src="<?php echo $url;?>js/tmStickUp.js"></script>
		<script src="<?php echo $url;?>js/jquery.ui.totop.js"></script>
		<script src="<?php echo $url;?>js/touchTouch.jquery.js"></script>
		<script src="<?php echo $url;?>js/owl.carousel.js"></script>
		<script src="<?php echo $url;?>js/sForm.js"></script>
		<script src="<?php echo $url;?>js/camera.js"></script>
		<!--[if (gt IE 9)|!(IE)]><!-->
